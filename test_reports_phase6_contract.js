...
includes('<th>Source</th><th>Submissions</th><th>Source Created</th><th>Last Sync</th><th>Spend</th><th>Unique Leads</th><th>Processed</th><th>Duplicate</th><th>Errors</th><th>Conversion %</th><th>CPL</th>', 'source spend headers')
includes('<th>Source</th><th>Form</th><th>Submissions</th><th>Unique Leads</th><th>Processed</th><th>Duplicate</th><th>Errors</th><th>Conversion %</th>', 'form headers without spend')
