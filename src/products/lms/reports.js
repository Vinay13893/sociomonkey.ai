      ...
      <div class="card" style="padding:14px 20px;">
        <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
          ...
          <div class="dash-filters" style="flex-wrap:wrap;">
            ...
            <div id="reportCustomRange" style="display:none"></div>
            <div class="dash-filter-group" style="display:none">
              <input type="hidden" id="reportDateFrom" value="${dateFrom}" />
              <input type="hidden" id="reportDateTo" value="${dateTo}" />
            </div>
    ...
    <div class="card" style="margin:0;">
      <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;margin-bottom:14px;">
        ...
        <div class="dash-filters" style="flex-wrap:wrap;box-shadow:none;border-color:#f1f5f9;padding:8px 12px;gap:8px;">
          ...
          <div id="teamCustomRange" style="display:none"></div>
          <div class="dash-filter-group" style="display:none">
            <input type="hidden" id="teamDateFrom" />
            <input type="hidden" id="teamDateTo" />
          </div>
          <div class="dash-filter-group">
